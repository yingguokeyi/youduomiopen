...
<head>
    ...
    <link rel="stylesheet" href="../css/mine/yhk_withdraw.css" />
    ...
    <div class="main_top">
        <header>
            <div class="title_top">
                ...
                <span class="title_top_center">银行卡提现</span>
                <span style="float:right;margin-right:.26rem;font-size:.28rem;color:#666" onclick="window.location='history_withdraw.jsp'">明细</span>
            </div>
        </header>
        <p class="wx_y">
            <span class="y_txt">当前余额:<span>100.00元</span></span>
        </p>
    </div>
    <div class="wifg"></div>
    <div class="main_bot">
        <p class="wx_name" onclick="window.location='bind_bankCard.jsp'">
            <span class="card_name">未选择银行卡</span>
            <span class="card_choose"><img src="../image/mine/enter.png" /></span>
        </p>
        <div class="wx_sum">
            <p>
                <input type="text" placeholder="请输入您的提现金额" value="" id="sumVal" />
            </p>
            <button type="button" id="wid_btn">提现</button>
        </div>
...
<script type="text/javascript" src="../js/mine/yhk_withdraw.js"></script>
</html>
